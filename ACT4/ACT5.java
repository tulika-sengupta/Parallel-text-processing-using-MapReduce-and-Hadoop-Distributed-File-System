...
public static class ACT5Mapper extends Mapper<Object, Text, Text, MapWritableExtend> {
...
public static class ACT5Reducer extends Reducer<Text,MapWritableExtend,Text,MapWritableExtend> {
        ...
        for(MapWritableExtend m:values){
           ...
           for (Writable key1 : keys) {
            ...
            for(Writable key2 : keys){
            	...
            	if(!key1.equals(key2)){
            		Text newWordPair = new Text("<" + key + "," + key1 + "," + key2 + ">");
 ...
 public static void main(String[] args) throws Exception {
    ...
    job.setJarByClass(ACT5.class);
    job.setMapperClass(ACT5Mapper.class);
    job.setCombinerClass(ACT5Reducer.class);
    job.setReducerClass(ACT5Reducer.class);
